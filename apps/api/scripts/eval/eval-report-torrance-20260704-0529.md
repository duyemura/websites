...
- Successful runs: 1/1
- Failed runs: 0/1
- Master fidelity (pre-heal): min 64, median 64.0, max 64
...
- Total sections / URL: min 11, median 11.0, max 11

## 2. Per-URL results

| # | URL | Duration | Sections | Rung1 | Vision | Fidelity (pre) | Fidelity (post) | Failed stage | Deploy |
|---|---|---|---|---|---|---|---|---|---|
| 1 | https://www.torrancetraininglab.com/ | 160.0s | 11 | 1 | yes | 64 | 78 |  | — |
