...
- Successful runs: 1/1
- Failed runs: 0/1
- Master fidelity (pre-heal): min 41, median 41.0, max 41
- Master fidelity (post-heal): min 44, median 44.0, max 44
...
- Total sections / URL: min 17, median 17.0, max 17

## 2. Per-URL results

| # | URL | Duration | Sections | Rung1 | Vision | Fidelity (pre) | Fidelity (post) | Failed stage |
|---|---|---|---|---|---|---|---|---|
| 1 | https://www.torrancetraininglab.com/ | 562.0s | 17 | 1 | yes | 41 | 44 |  |
