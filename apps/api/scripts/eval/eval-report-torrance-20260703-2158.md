...
- Successful runs: 1/1
- Failed runs: 0/1
- Master fidelity (pre-heal): min 58, median 58.0, max 58
- Master fidelity (post-heal): min 58, median 58.0, max 58
...
- Total sections / URL: min 13, median 13.0, max 13

## 2. Per-URL results

| # | URL | Duration | Sections | Rung1 | Vision | Fidelity (pre) | Fidelity (post) | Failed stage |
|---|---|---|---|---|---|---|---|---|
| 1 | https://www.torrancetraininglab.com/ | 866.8s | 13 | 1 | yes | 58 | 58 |  |
