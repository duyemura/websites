...
- Successful runs: 1/1
- Failed runs: 0/1
- Master fidelity (pre-heal): min 16, median 16.0, max 16
- Master fidelity (post-heal): min 16, median 16.0, max 16
...
|---|---|---|---|---|---|---|---|---|
| 1 | https://www.torrancetraininglab.com/ | 181.2s | 2 | 1 | yes | 16 | 16 |  |
