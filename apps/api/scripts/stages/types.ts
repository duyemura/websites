...
export interface StageCosts {
  ...
  /** LLM input tokens consumed by this stage */
  llmInputTokens?: number;
  /** LLM output tokens generated by this stage */
  llmOutputTokens?: number;
  /** Number of LLM API calls made by this stage */
  llmCalls?: number;
  /** Estimated LLM cost in USD for this stage */
  llmEstimatedUsd?: number;
  /** Per-model breakdown of LLM usage */
  llmByModel?: Record<string, { inputTokens: number; outputTokens: number; calls: number; estimatedUsd: number }>;
}
